        ...
        def get_config():
            ...
            if self.config:
                return jsonify(
                    {
                        "model": getattr(
                            self.config.transcription, "model_name", "unknown"
                        ),
                        "language": getattr(
                            self.config.transcription, "language", "auto"
                        ),
                        ...
                        "translation_target": getattr(
                            self.config.translation, "target_language", "pt"
                        ),
                    }
                )
            return jsonify({})
